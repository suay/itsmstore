...
if ( ! class_exists( 'YITH_WC_Subscription_Assets' ) ) {
	...
	class YITH_WC_Subscription_Assets {
		...
		public function register_admin_scripts() {
			...
			wp_register_script( 'datatables', 'https://cdn.datatables.net/1.10.22/js/jquery.dataTables.min.js', array( 'jquery' ), true );
		...
		public function script_translations( $json_translations, $file, $handle, $domain ) {
			if ( 'yith-woocommerce-subscription' === $domain && in_array( $handle, array( 'ywsbs-plans-editor-script' ) ) ) {
