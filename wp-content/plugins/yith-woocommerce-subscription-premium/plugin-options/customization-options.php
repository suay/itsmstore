...
$section2 = array(
	...
	'text_cancel_subscription_dropdown' => array(
		...
		'textarea_rows' => 5,
		'default'       => __(
			'<strong>Cancel subscription</strong><p>If you want to cancel the subscription, you will lose access to the subscription you purchased.</p>', 'yith-woocommerce-subscription'
		),
		'deps'          => array(
			'id'    => 'ywsbs_subscription_action_style',
			'value' => 'dropdown',
...
blocked. You can pause this subscription only for {{max_pause_number}} times.</p>', 'yith-woocommerce-subscription'
		),
	),
	...
	'text_resume_subscription_modal' => array(
		...
		'yith-type'     => 'textarea-editor',
		'textarea_rows' => 5,
		'default'       => __( '<strong>Are you sure you want to resume this subscription?</strong>', 'yith-woocommerce-subscription' ),
	),
	...
	'text_cancel_subscription_modal' => array(
		...
		'yith-type'     => 'textarea-editor',
		'textarea_rows' => 5,
		'default'       => __( '<strong>Are you sure you want to cancel this subscription?</strong>', 'yith-woocommerce-subscription' ),
		'deps'          => array(
			'id'    => 'ywsbs_allow_customer_cancel_subscription',
			'value' => 'yes',
		),
