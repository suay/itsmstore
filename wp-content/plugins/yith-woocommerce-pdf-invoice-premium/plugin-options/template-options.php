...
{{_shipping_country}}',
        ...
        'ywpi_credit_note_template_style'         => array(
            'name' => __( 'Create a corrected invoice with products', 'yith-woocommerce-pdf-invoice' ),
            'type'    => 'yith-field',
            'yith-type' => 'onoff',
            'id'   => 'ywpi_credit_note_template_style_checkbox',
            'desc' => __( 'Create a corrected invoice, with the same style than the default invoice, but with the refunded values in negative.', 'yith-woocommerce-pdf-invoice' ),
            'default'       => 'no',
        ),
