    ...
    class YITH_Electronic_Invoice {
        ...
        public function enqueue_scripts(){
            ...
            $options = array(
                ...
                'optional_label'      =>  __( apply_filters( 'ywpi_checkout_optional_label', '(optional)') ),
	    ...
	    public function validate_checkout_fields( $data, $errors ){
		    ...
		    if ( apply_filters( 'yith_ywpi_validate_checkout_fields_conditions', true , $data  ) ) {
			    ...
			    } elseif ( $data['billing_country'] == 'IT' && isset( $data['billing_vat_ssn'] ) && ( ( ( $is_receipt_enabled === 'yes' && $data['billing_invoice_type'] === 'invoice' ) ) || $is_receipt_enabled === 'no' ) ) {
        ...
        public function is_eur_country( $country ){
            ...
            return in_array( $country, $eur_countries ) ? true : false;
        }
