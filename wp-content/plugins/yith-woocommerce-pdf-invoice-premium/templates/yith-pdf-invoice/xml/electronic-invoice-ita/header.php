<FatturaElettronicaHeader>
    ...
    <CessionarioCommittente>
        <DatiAnagrafici>
            ...
            <?php elseif( $invoice_details['customer']['is_private'] == true && $invoice_details['customer']['billing_country'] != 'IT' ): ?>    
                <IdFiscaleIVA>
					<IdPaese><?php echo $invoice_details['customer']['billing_country'] ?></IdPaese>
                    <IdCodice>0000000</IdCodice>
                </IdFiscaleIVA>
            <?php endif; ?>
            <?php if( $invoice_details['customer']['billing_ssn'] != '' && $invoice_details['customer']['billing_country'] == 'IT' ): ?>
        ...
        <Sede>
            ...
            <CAP><?php echo $invoice_details['customer']['billing_postcode'] != '' ? $invoice_details['customer']['billing_postcode'] : '00000' ?></CAP>
