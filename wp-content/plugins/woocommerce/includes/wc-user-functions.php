...
/*  ======================= start auto single sign on for open ticket edit : 02-06-2021 =============================== */
		//var_dump($new_customer_data,$customer_id);

		//curl auth for call create nsdx


		$curl = curl_init();

		curl_setopt_array($curl, array(
		  CURLOPT_URL => 'http://10.1.8.34/api/login/standard',
		...
		$auth = $data['Info']['AuthorizationToken'];
		// //curl send create user nsdx
		$dataput = json_encode( array(
			...
			curl_setopt_array($curl1, array(
			  CURLOPT_URL => 'http://10.1.8.34/api/admin/CreateNewUserCustomer',
			  CURLOPT_RETURNTRANSFER => true,
			  CURLOPT_ENCODING => '',
			  CURLOPT_MAXREDIRS => 10,
			  CURLOPT_TIMEOUT => 0,
			...
			curl_close($curl1);
			//echo $response;
	/* ================= End auto single sign on for open ticket ================================ */
